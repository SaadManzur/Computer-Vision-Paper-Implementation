...
def show_axis(image_name, P):
    ...
    resized_img = opencv.resize(input_img, (int(input_img.shape[1] / 5), int(input_img.shape[0] / 5)))
    opencv.imshow("origin", resized_img)
    opencv.waitKey(5000)


if __name__ == '__main__':
    filename = 'resources/mi 6x/4089_marker2.jpg'
